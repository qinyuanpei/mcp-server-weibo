...
| Let a coding agent follow the project's CLI conventions | [Weibo CLI Skill](skills/weibo-cli/SKILL.md) |
| Let an agent fetch Weibo data and generate a personality report | [Weibo Personality Skill](skills/weibo-personality/SKILL.md) |
