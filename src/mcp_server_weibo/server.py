...
async def search_users(
    ...
    limit: Annotated[
        int,
        Field(
            description="Maximum number of users to return, defaults to 5", default=5
        ),
    ] = 5,
    page: Annotated[
        int, Field(description="Page number for pagination, defaults to 1", default=1)
    ] = 1,
) -> list[dict]:
    """
...
async def get_feeds(
    ...
    limit: Annotated[
        int,
        Field(
            description="Maximum number of feeds to return, defaults to 15", default=15
        ),
    ] = 15,
) -> list[dict]:
    """
...
async def get_followers(
    ...
    limit: Annotated[
        int,
        Field(
            description="Maximum number of followers to return, defaults to 15",
            default=15,
        ),
    ] = 15,
    page: Annotated[
...
async def get_fans(
    ...
    limit: Annotated[
        int,
        Field(
            description="Maximum number of fans to return, defaults to 15", default=15
        ),
    ] = 15,
    page: Annotated[
        int, Field(description="Page number for pagination, defaults to 1", default=1)
...
async def get_comments(
    ctx: Context,
    feed_id: Annotated[
        int, Field(description="The unique identifier of the Weibo post")
    ],
    page: Annotated[
        int, Field(description="Page number for pagination, defaults to 1", default=1)
    ] = 1,
